<?php
	...
	$sql = 'SELECT COUNT(ProjectId) AS C FROM PROJECT';
		...
		$("#pagination").paging(<?php echo $page ?>, {
			...
			onSelect: function(page) {
				...
				$.ajax({
					...
					"url": 'projdata.php?start=' + this.slice[0] + '&end=' + this.slice[1] + '&page=' + page,
	...
	<div id="page-bgtop">
		...
		<div id="content">
        	...
        	<div align="right" style="margin-top:-20px; padding-bottom:10px;"> 
                ...
                <form id="langform" name="langform" action="research.php" method="post">
            ...
            <h3 class="title">
                ...
                <?php
                    ...
                    $sql = 'SELECT TextMsg FROM MSGTEXT WHERE MsgKey = \'PROJ00001\' AND Lang = \''.$_SESSION["lang"].'\'';
