<?php
	...
	$sql = 'SELECT COUNT(PublicationId) AS C FROM PUBLICATION';
		...
		$("#pagination").paging(<?php echo $page ?>, {
			...
			onSelect: function(page) {
				...
				$.ajax({
					...
					"url": 'publdata.php?start=' + this.slice[0] + '&end=' + this.slice[1] + '&page=' + page,
	...
	<div id="page-bgtop">
		...
		<div id="content">
        	...
        	<div align="right" style="margin-top:-20px; padding-bottom:10px;"> 
                ...
                <form id="langform" name="langform" action="publication.php" method="post">
            ...
            <h3 class="title">
                ...
                <?php
                    ...
                    $sql = 'SELECT TextMsg FROM MSGTEXT WHERE MsgKey = \'PROJ00002\' AND Lang = \''.$_SESSION["lang"].'\'';
